...
export class WhatsAppConfig {
  constructor(source = process.env) {
    ...
    this.whatsappAuthTemplate = clean(source.WHATSAPP_AUTH_TEMPLATE) || 'litepuff_authentication';
    this.whatsappOrderTemplate = clean(source.WHATSAPP_ORDER_TEMPLATE) || 'litepuff_order_confirmation';
    this.whatsappShippingTemplate = clean(source.WHATSAPP_SHIPPING_TEMPLATE) || 'litepuff_shipping_update';
    ...
    this.whatsappPaymentSuccessTemplate = clean(source.WHATSAPP_PAYMENT_SUCCESS_TEMPLATE) || 'litepuff_payment_success';
    this.whatsappPaymentFailedTemplate = clean(source.WHATSAPP_PAYMENT_FAILED_TEMPLATE) || 'litepuff_payment_failed';
    ...
    this.whatsappDeliveredTemplate = clean(source.WHATSAPP_DELIVERED_TEMPLATE) || 'litepuff_delivered';
  ...
  get outboundConfigured() { return Boolean(this.whatsappAccessToken && this.whatsappPhoneNumberId && this.whatsappBusinessAccountId); }
