...
export const SHEET_SCHEMAS = Object.freeze({
  ...
  ORDERS: ['OrderID', 'OrderNumber', 'CustomerID', 'AddressID', 'Subtotal', 'Shipping', 'Discount', 'Tax', 'GrandTotal', 'CouponCode', 'PaymentMethod', 'PaymentStatus', 'OrderStatus', 'TrackingNumber', 'EstimatedDelivery', 'CreatedAt', 'UpdatedAt'],
...
export const SHEET_RULES = Object.freeze({
  ...
  ORDERS: { primaryKey: 'OrderID', unique: [['OrderNumber']], foreign: { CustomerID: ['CUSTOMERS', 'CustomerID'], AddressID: ['ADDRESSES', 'AddressID'] }, numeric: ['Subtotal', 'Shipping', 'Discount', 'Tax', 'GrandTotal'] },
