...
const config = { outboundConfigured: true, configured: true, webhookConfigured: true, metaAppSecret: 'secret', metaApiVersion: 'v23.0', whatsappPhoneNumberId: 'phone-id', whatsappBusinessAccountId: 'business-id', whatsappAccessToken: 'token', whatsappTimeoutMs: 1000, whatsappMaxRetries: 2, whatsappTemplateLanguage: 'en_US', whatsappAuthTemplate: 'litepuff_authentication', whatsappOrderTemplate: 'litepuff_order_confirmation', whatsappShippingTemplate: 'litepuff_shipping_update', whatsappMarketingTemplate: 'litepuff_marketing', publicState: () => ({ configured: true, outboundConfigured: true, webhookConfigured: true, apiVersion: 'v23.0', phoneNumberId: 'phone-id', businessAccountId: 'business-id', reason: null }) };
