...
export const adminService = {
  ...
  updateReview: async (id, payload) => unwrap(await apiClient.patch(`/admin/reviews/${id}`, typeof payload === 'string' ? { status: payload } : payload)),
  replyReview: async (id, reply) => unwrap(await apiClient.post(`/admin/reviews/${id}/reply`, { reply })),
