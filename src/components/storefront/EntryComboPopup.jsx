...
export default function EntryComboPopup() {
  ...
  return <div className="fixed inset-0 z-[110] grid place-items-end bg-black/50 p-0 sm:place-items-center sm:p-5" onMouseDown={(event) => event.target === event.currentTarget && later()}>
    <section ref={dialog} tabIndex="-1" role="dialog" aria-modal="true" aria-labelledby="combo-popup-title" className="relative grid max-h-[92svh] w-full overflow-y-auto rounded-t-[28px] bg-[#FAF8F2] shadow-2xl outline-none md:max-w-[1100px] md:grid-cols-[56%_44%] md:overflow-hidden md:rounded-[28px]">
